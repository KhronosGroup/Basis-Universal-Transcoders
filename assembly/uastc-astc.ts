...
// @ts-ignore: 1206
@inline
function repackASTC(q0: i64, q1: i64, offset: i32): void {
  const voidExtent: i64 = 0xFFFFFFFFFFFFFDFC;
  const errorColor: i64 = 0xFFFFFFFF0000FFFF;

  let r0: i64 = 0;
  let r1: i64 = 0;

  let modeIndex = getModeIndex(<i32>q0 & 0x7F);
  ...
  modeIndex = (modeIndex == 4) ? 7 : modeIndex;
  ...
  switch (modeIndex) {
    case 0:
      {
        ...
        // 6-bit endpoints
        const rl0 = <i32>(q0 >> 29) & 0x3F;
        const rh0 = <i32>(q0 >> 35) & 0x3F;
        const gl0 = <i32>(q0 >> 41) & 0x3F;
        const gh0 = <i32>(q0 >> 47) & 0x3F;
        const bl0 = <i32>(q0 >> 53) & 0x3F;
        const bh0 = (<i32>(q0 >> 59) & 0x1F) | (<i32>(q1 << 5) & 0x20);
    ...
    case 1:
      {
        ...
        r1 = (<i64>packedWeights << 32) | (packedEndpoints >>> 47);
      }
      break;
    case 2:
      {
        ...
        // 4-bit endpoints
        const rl0 = <i32>(q0 >> 25) & 0xF;
        const rh0 = <i32>(q0 >> 29) & 0xF;
        const gl0 = <i32>(q0 >> 33) & 0xF;
        const gh0 = <i32>(q0 >> 37) & 0xF;
        const bl0 = <i32>(q0 >> 41) & 0xF;
        const bh0 = <i32>(q0 >> 45) & 0xF;
        const rl1 = <i32>(q0 >> 49) & 0xF;
        const rh1 = <i32>(q0 >> 53) & 0xF;
        const gl1 = <i32>(q0 >> 57) & 0xF;
        const gh1 = (<i32>(q0 >> 61) & 0x7) | (<i32>(q1 << 3) & 0x8);
        const bl1 = <i32>(q1 >> 1) & 0xF;
        const bh1 = <i32>(q1 >> 5) & 0xF;
        ...
        const hiMask: i64 = (0xFFFFFFFFFFFFFFFF << ((anchor * 3) + 3)) & 0xFFFFFFFFFFFF;
        ...
        const packedEndpoints = (<i64>packedEndpoints1 << 24) | <i64>packedEndpoints0;
    ...
    case 3:
      {
        ...
        // 2-bit endpoints
        const rl0 = <i32>(q0 >> 53) & 0x3;
        const rh0 = <i32>(q0 >> 55) & 0x3;
        const gl0 = <i32>(q0 >> 57) & 0x3;
        const gh0 = <i32>(q0 >> 59) & 0x3;
        const bl0 = <i32>(q0 >> 61) & 0x3;
        const bh0 = (<i32>(q0 >> 63) & 0x1) | (<i32>(q1 << 1) & 0x2);
        const rl1 = <i32>(q1 >> 1) & 0x3;
        const rh1 = <i32>(q1 >> 3) & 0x3;
        const gl1 = <i32>(q1 >> 5) & 0x3;
        const gh1 = <i32>(q1 >> 7) & 0x3;
        const bl1 = <i32>(q1 >> 9) & 0x3;
        const bh1 = <i32>(q1 >> 11) & 0x3;
        const rl2 = <i32>(q1 >> 13) & 0x3;
        const rh2 = <i32>(q1 >> 15) & 0x3;
        const gl2 = <i32>(q1 >> 17) & 0x3;
        const gh2 = <i32>(q1 >> 19) & 0x3;
        const bl2 = <i32>(q1 >> 21) & 0x3;
        const bh2 = <i32>(q1 >> 23) & 0x3;
        ...
        const packedBits1 =
          interleaveBits2T(
            ...
            0, 0);
        const packedTrits0 =
          (<i64>interleaveTrits2(t2) << 36) |
          (<i64>interleaveTrits2(t1) << 18) |
          interleaveTrits2(t0);
        ...
        r1 = (<i64>packedWeights << 32) | (packedEndpoints1 << 19) | (packedEndpoints0 >>> 35);
      }
      break;
    case 7:
      {
        ...
        // 3-bit endpoints
        const rl0 = <i32>(q0 >> 53) & 0x7;
        const rh0 = <i32>(q0 >> 56) & 0x7;
        const gl0 = <i32>(q0 >> 59) & 0x7;
        const gh0 = (<i32>(q0 >> 62) & 0x3) | (<i32>(q1 << 2) & 0x4);
        const bl0 = <i32>(q1 >> 1) & 0x7;
        const bh0 = <i32>(q1 >> 4) & 0x7;
        const rl1 = <i32>(q1 >> 7) & 0x7;
        const rh1 = <i32>(q1 >> 10) & 0x7;
        const gl1 = <i32>(q1 >> 13) & 0x7;
        const gh1 = <i32>(q1 >> 16) & 0x7;
        const bl1 = <i32>(q1 >> 19) & 0x7;
        const bh1 = <i32>(q1 >> 22) & 0x7;
        ...
        const packedQuints =
          (<i64>interleaveQuints3(qu3) << 48) | (<i64>interleaveQuints3(qu2) << 32) |
        ...
        r1 = (<i64>packedWeights << 32) | (packedEndpoints >>> 35);
      }
      break;
    case 5:
      {
    ...
    case 6:
      {
        ...
        // 5-bit endpoints
        const rl0 = <i32>(q0 >> 36) & 0x1F;
        const rh0 = <i32>(q0 >> 41) & 0x1F;
        const gl0 = <i32>(q0 >> 46) & 0x1F;
        const gh0 = <i32>(q0 >> 51) & 0x1F;
        const bl0 = <i32>(q0 >> 56) & 0x1F;
        const bh0 = (<i32>(q0 >> 61) & 0x7) | (<i32>(q1 << 3) & 0x18);
        ...
        const packedBits = interleaveBits5Qx2(
          ...
          swap ? gh0 : gl0, swap ? gl0 : gh0,
          swap ? bh0 : bl0, swap ? bl0 : bh0);
        const packedQuints = (<i64>interleaveQuints5(qu1) << 22) | interleaveQuints5(qu0);
        const packedEndpoints = packedBits | packedQuints;
        const packedWeights = reverse64(swap ? ~weights : weights);

        // ASTC Mode 1090 (Dp), CEM 8, 17-bit header
        r0 = (<i64>compSel << 62) | (packedEndpoints << 17) | 0x10442;
        r1 = packedWeights;
      }
      break;
    case 8:
    ...
    case 9:
      {
        ...
        // 4-bit endpoints
        const rl0 = <i32>(q0 >> 33) & 0xF;
        const rh0 = <i32>(q0 >> 37) & 0xF;
        const gl0 = <i32>(q0 >> 41) & 0xF;
        const gh0 = <i32>(q0 >> 45) & 0xF;
        const bl0 = <i32>(q0 >> 49) & 0xF;
        const bh0 = <i32>(q0 >> 53) & 0xF;
        const al0 = <i32>(q0 >> 57) & 0xF;
        const ah0 = (<i32>(q0 >> 61) & 0x7) | (<i32>(q1 << 3) & 0x8);
        const rl1 = <i32>(q1 >> 1) & 0xF;
        const rh1 = <i32>(q1 >> 5) & 0xF;
        const gl1 = <i32>(q1 >> 9) & 0xF;
        const gh1 = <i32>(q1 >> 13) & 0xF;
        const bl1 = <i32>(q1 >> 17) & 0xF;
        const bh1 = <i32>(q1 >> 21) & 0xF;
        const al1 = <i32>(q1 >> 25) & 0xF;
        const ah1 = <i32>(q1 >> 29) & 0xF;
        ...
        const weights = <i32>(((q1 >> 31) & hiMask) | ((q1 >> 32) & loMask) | ((q1 >> 33) & 1));

        // Check blue contraction and pack endpoints & weights
        const swap0 = (rl0 + gl0 + bl0) > (rh0 + gh0 + bh0);
        const swap1 = (rl1 + gl1 + bl1) > (rh1 + gh1 + bh1);
        const packedEndpoints0 =
          (packRGBAz4(rh0, gh0, bh0, ah0) << (swap0 ? 0 : 4)) | (packRGBAz4(rl0, gl0, bl0, al0) << (swap0 ? 4 : 0));
        const packedEndpoints1 =
          (packRGBAz4(rh1, gh1, bh1, ah1) << (swap1 ? 0 : 4)) | (packRGBAz4(rl1, gl1, bl1, al1) << (swap1 ? 4 : 0));
        const packedEndpoints = (<i64>packedEndpoints1 << 32) | <u32>packedEndpoints0;
    ...
    case 10:
      {
        ...
        const packedTrits = (<i64>interleaveTrits4(t1) << 28) | interleaveTrits4(t0);
        const packedEndpoints = packedBits | packedTrits;
        const packedWeights = reverse64(swap ? ~weights : weights);
    ...
    case 11:
      {
        ...
        // 4-bit endpoints
        const rl0 = <i32>(q0 >> 34) & 0xF;
        const rh0 = <i32>(q0 >> 38) & 0xF;
        const gl0 = <i32>(q0 >> 42) & 0xF;
        const gh0 = <i32>(q0 >> 46) & 0xF;
        const bl0 = <i32>(q0 >> 50) & 0xF;
        const bh0 = <i32>(q0 >> 54) & 0xF;
        const al0 = <i32>(q0 >> 58) & 0xF;
        const ah0 = (<i32>(q0 >> 62) & 0x3) | (<i32>(q1 << 2) & 0xC);
        ...
        r0 = (<i64>compSel << 62) | (packedEndpoints << 17) | 0x18442;
        r1 = packedWeights;
      }
      break;
    case 12:
      {
        ...
        // 6-bit endpoints
        const rl0 = <i32>(q0 >> 33) & 0x3F;
        const rh0 = <i32>(q0 >> 39) & 0x3F;
        const gl0 = <i32>(q0 >> 45) & 0x3F;
        const gh0 = <i32>(q0 >> 51) & 0x3F;
        const bl0 = <i32>(q0 >> 57) & 0x3F;
        const bh0 = (<i32>(q0 >> 63) & 0x1) | (<i32>(q1 << 1) & 0x3E);
        const al0 = <i32>(q1 >> 5) & 0x3F;
        const ah0 = <i32>(q1 >> 11) & 0x3F;
    ...
    case 13:
      {
        ...
        const weights = <i32>((q1 >> 28) & 0xFFFFFFFC);
        ...
        r1 = (<i64>packedWeights << 32) | (<i64>compSel << 30) | (packedEndpoints >>> 47);
      }
      break;
    case 14:
      {
        ...
        const weights = <i32>(((q1 >> 27) & 0xFFFFFFFC) | ((q1 >> 28) & 1));
    ...
    case 18:
      {
        // 5-bit endpoints
        const rl0 = <i32>(q0 >> 19) & 0x1F;
        const rh0 = <i32>(q0 >> 24) & 0x1F;
        const gl0 = <i32>(q0 >> 29) & 0x1F;
        const gh0 = <i32>(q0 >> 34) & 0x1F;
        const bl0 = <i32>(q0 >> 39) & 0x1F;
        const bh0 = <i32>(q0 >> 44) & 0x1F;

        // 5-bit weights, start at 49
        // All 16 weights do not fit into a single 64-bit variable,
        // split them as 12.8 (64) + 3.2 (16).
        const weightsExtra = <i32>(q1 >> 48) & 0xFFFF;
        ...
        r0 = (<i64>packedWeightsExtra << 48) | (<i64>packedEndpoints << 17) | 0x10253;
        r1 = packedWeights;
      }
      break;
    default:
...
function storeAstcPatternIndices(): void {
  store<i64>(threeSubsetsPatternIndicesOffset, 0x009C0020004A0104, 0);
  store<i64>(threeSubsetsPatternIndicesOffset, 0x000002E9000F00B7, 8);
  store<i64>(threeSubsetsPatternIndicesOffset, 0x000000FE0386014F, 16);

  store<i64>(twoSubsetsModeIndex7PatternIndicesOffset, 0x0089003D00300024, 0);
  store<i64>(twoSubsetsModeIndex7PatternIndicesOffset, 0x011900E200B700A1, 8);
  store<i64>(twoSubsetsModeIndex7PatternIndicesOffset, 0x01EF01DF0133012E, 16);
  store<i64>(twoSubsetsModeIndex7PatternIndicesOffset, 0x031F025D02520251, 24);
  store<i64>(twoSubsetsModeIndex7PatternIndicesOffset, 0x000003E103DC032C, 32);

  store<i64>(twoSubsetsPatternIndicesOffset, 0x001D00100014001C, 0);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x0048006B0009005B, 8);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x0072003200CC0095, 16);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x0027004E001101F0, 24);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x009C002B033C00FC, 32);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x011101DC00D20074, 40);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x00C300F6016702AC, 48);
  store<i64>(twoSubsetsPatternIndicesOffset, 0x00000000020C02B6, 56);
}
...
// @ts-ignore: 1206
@inline
function getTwoSubsetsPatternIndex(i: i32): i32 {
...
// @ts-ignore: 1206
@inline
function getTwoSubsetsPatternIndexForModeIndex7(i: i32): i32 {
...
// @ts-ignore: 1206
@inline
function getThreeSubsetsPatternIndex(i: i32): i32 {
...
// @ts-ignore: 1206
@inline
function packRGBAz4(r: i32, g: i32, b: i32, a: i32): i32 {
...
// @ts-ignore: 1206
@inline
function packRGBz5(r: i32, g: i32, b: i32): i32 {
  return (b << 20) | (g << 10) | r;
}
...
// @ts-ignore: 1206
@inline
function packRGBAz8(r: i32, g: i32, b: i32, a: i32): i64 {
  return (<i64>a << 48) | (<i64>b << 32) | (g << 16) | r;
}
...
function storeTritsAstc(): void {
  store<i64>(tritEncodingOffset, 650776764766880000, 0);
  store<i64>(tritEncodingOffset, 1735597882344542218, 8);
  store<i64>(tritEncodingOffset, 1952049901571611161, 16);
  store<i64>(tritEncodingOffset, 2676301604231974156, 24);
  store<i64>(tritEncodingOffset, 3761122721743317030, 32);
  store<i64>(tritEncodingOffset, 3109492800697677365, 40);
  store<i64>(tritEncodingOffset, 4701808782525282099, 48);
  store<i64>(tritEncodingOffset, 5785517246076240962, 56);
  store<i64>(tritEncodingOffset, 6510331864162783825, 64);
  store<i64>(tritEncodingOffset, 5569927269768185667, 72);
  store<i64>(tritEncodingOffset, -8609046833500422066, 80);
  store<i64>(tritEncodingOffset, -7596001839262168439, 88);
  store<i64>(tritEncodingOffset, -7524517138261173864, 96);
  store<i64>(tritEncodingOffset, -6583521994303763301, 104);
  store<i64>(tritEncodingOffset, -5570477017043261787, 112);
  store<i64>(tritEncodingOffset, -6367040141341051468, 120);
  store<i64>(tritEncodingOffset, -4562518415084375125, 128);
  store<i64>(tritEncodingOffset, -3834312851682180415, 136);
  store<i64>(tritEncodingOffset, -2749211358622723632, 144);
  store<i64>(tritEncodingOffset, -3685114565415681062, 152);
  store<i64>(tritEncodingOffset, 7378413938219732685, 160);
  store<i64>(tritEncodingOffset, 8463515431278897512, 168);
  store<i64>(tritEncodingOffset, 8316854813823957110, 176);
  store<i64>(tritEncodingOffset, -2098149186491090057, 184);
  store<i64>(tritEncodingOffset, -1013051625802635804, 192);
  store<i64>(tritEncodingOffset, -2019026635231726350, 200);
  store<i64>(tritEncodingOffset, -1230066556261372953, 208);
  store<i64>(tritEncodingOffset, 6727320376107212060, 216);
  store<i64>(tritEncodingOffset, -2540384521977750434, 224);
  store<i64>(tritEncodingOffset, -2323963651270123811, 232);
  store<i64>(tritEncodingOffset, 8289660, 240);
}
...
// @ts-ignore
@inline
function packTrits(t0: i32, t1: i32, t2: i32, t3: i32, t4: i32): i32 {
...
// @ts-ignore
@inline
function interleaveTrits2(t: i32): i32 {
  return ((t & 0x80) << 10) |
    ((t & 0x60) << 8) |
    ((t & 0x10) << 6) |
    ((t & 0xC) << 4) |
...
function interleaveBits2T(
  v0: i32, v1: i32, v2: i32, v3: i32, v4: i32): i32 {
  return (v4 << 15) | (v3 << 11) | (v2 << 8) | (v1 << 4) | v0;
}
...
// @ts-ignore
@inline
function interleaveTrits4(t: i32): i32 {
  return ((t & 0x80) << 20) |
    ((t & 0x60) << 16) |
    ((t & 0x10) << 12) |
    ((t & 0xC) << 8) |
...
function interleaveBits4Tx2(
  ...
  v5: i32, v6: i32, v7: i32): i64 {
  return (<i64>v7 << 40) | (<i64>v6 << 34) | (<i64>v5 << 28) | (v4 << 23) |
    (v3 << 17) | (v2 << 12) | (v1 << 6) | v0;
}
...
// @ts-ignore
@inline
function interleaveTrits6(t: i32): i64 {
  return (<i64>(t & 0x80) << 30) |
    ((t & 0x60) << 24) |
    ((t & 0x10) << 18) |
    ((t & 0xC) << 12) |
    ((t & 0x3) << 6);
...
function interleaveBits6Tx2(
  v0: i32, v1: i32, v2: i32, v3: i32, v4: i32,
  v5: i32, v6: i32, v7: i32): i64 {
  return (<i64>v7 << 54) | (<i64>v6 << 46) | (<i64>v5 << 38) |
    (<i64>v4 << 31) | (v3 << 23) | (v2 << 16) | (v1 << 8) | v0;
}
...
function storeQuintsAstc(): void {
  store<i64>(quintEncodingOffset, 0x0A09080403020100, 0);
  store<i64>(quintEncodingOffset, 0x1814131211100C0B, 8);
  store<i64>(quintEncodingOffset, 0x1D150D051C1B1A19, 16);
  store<i64>(quintEncodingOffset, 0x2928242322212006, 24);
  store<i64>(quintEncodingOffset, 0x34333231302C2B2A, 32);
  store<i64>(quintEncodingOffset, 0x352D253C3B3A3938, 40);
  store<i64>(quintEncodingOffset, 0x4844434241400E3D, 48);
  store<i64>(quintEncodingOffset, 0x535251504C4B4A49, 56);
  store<i64>(quintEncodingOffset, 0x4D455C5B5A595854, 64);
  store<i64>(quintEncodingOffset, 0x6463626160165D55, 72);
  store<i64>(quintEncodingOffset, 0x7271706C6B6A6968, 80);
  store<i64>(quintEncodingOffset, 0x657C7B7A79787473, 88);
  store<i64>(quintEncodingOffset, 0x474667661E7D756D, 96);
  store<i64>(quintEncodingOffset, 0x77762E4F4E6F6E26, 104);
  store<i64>(quintEncodingOffset, 0x3E5F5E7F7E365756, 112);
  store<i64>(quintEncodingOffset, 0x0000001F3F372F27, 120);
}
...
// @ts-ignore
@inline
function packQuints(q0: i32, q1: i32, q2: i32): i32 {
...
// @ts-ignore
@inline
function interleaveQuints3(q: i32): i32 {
  return ((q & 0x60) << 9) |
    ((q & 0x18) << 6) |
    ((q & 0x7) << 3);
}
...
function interleaveBits3Qx2(
  v0: i32, v1: i32, v2: i32,
  v3: i32, v4: i32, v5: i32): i32 {
  return (v5 << 27) | (v4 << 22) | (v3 << 16) |
    (v2 << 11) | (v1 << 6) | v0;
}
...
// @ts-ignore
@inline
function interleaveQuints5(q: i32): i32 {
  return ((q & 0x60) << 15) |
    ((q & 0x18) << 10) |
    ((q & 0x7) << 5);
}
...
function interleaveBits5Qx2(
  v0: i32, v1: i32, v2: i32,
  v3: i32, v4: i32, v5: i32): i64 {
  return (<i64>v5 << 37) | (<i64>v4 << 30) | (v3 << 22) |
    (v2 << 15) | (v1 << 8) | v0;
}
