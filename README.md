...
These transcoders accept only low-level compressed payloads. Containers such as `.basis` or `.ktx2` ([KTX](https://github.com/KhronosGroup/KTX-Specification#readme)) should first be parsed by other means, then transcoded to the target format with this library.
